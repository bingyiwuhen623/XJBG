...
public class TweenVector2 : TweenBase
{
    ...
    public void Init(Vector2 start, Vector2 end, EaseType ease, LoopType loop, int loopTimes, float time)
    {
        mStart = start;
        mEnd = end;
        mCurrValue = mStart;
    ...
    protected override void SetValue()
    {
        ...
        mCurrValue = new Vector2(xValue, yValue);
    }
}